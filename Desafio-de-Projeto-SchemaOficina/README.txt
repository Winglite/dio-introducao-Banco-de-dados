...
- Cliente levam veículos à oficina mecânica para serem cnsertados ou para passarem por revisões periódicas.
...
- O cliente autoriz a execução dos serviços.
- A mesma equipe avalia e executa os serviços
- Os mecânicos possuem código, nome, endereço e especialidade
- Cada OS possui: N°, data de emissão, um valor, status e uma data para conclusão dos trabalhos.
- Uma OS pode ser composta por vários servuços e um mesmo serviço pode estar contido em mais de uma OS.
